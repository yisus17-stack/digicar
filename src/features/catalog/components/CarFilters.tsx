            ...
            <Label>Combustible</Label>
              <Select value={filters.fuelType} onValueChange={(value) => handleSelectChange('fuelType', value)}>
                  ...
                  <SelectContent>
                      ...
                      {uniqueFuelTypes.map((type, index) => <SelectItem key={`${type}-${index}`} value={type}>{type}</SelectItem>)}
                  </SelectContent>
              </Select>
        </div>
            ...
            <Label>Color</Label>
              <Select value={filters.color} onValueChange={(value) => handleSelectChange('color', value)}>
                  ...
                  <SelectContent>
                      ...
                      {uniqueColors.map((color, index) => <SelectItem key={`${color}-${index}`} value={color}>{color}</SelectItem>)}
                  </SelectContent>
              </Select>
        </div>
            ...
            <Label>Transmisión</Label>
              <Select value={filters.transmission} onValueChange={(value) => handleSelectChange('transmission', value)}>
                  ...
                  <SelectContent>
                      ...
                      {uniqueTransmissions.map((type, index) => <SelectItem key={`${type}-${index}`} value={type}>{type}</SelectItem>)}
                  </SelectContent>
              </Select>
        </div>
      </div>
