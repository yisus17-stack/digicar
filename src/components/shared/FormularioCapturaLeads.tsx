...
interface FormularioCapturaLeadsProps {
  autosInteres?: string;
}

export default function FormularioCapturaLeads({ autosInteres = '' }: FormularioCapturaLeadsProps) {
